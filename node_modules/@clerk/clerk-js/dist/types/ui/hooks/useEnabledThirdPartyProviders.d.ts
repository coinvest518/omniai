...
export declare const useEnabledThirdPartyProviders: () => {
    strategies: (OAuthStrategy | "web3_coinbase_signature" | "web3_metamask_signature" | "web3_coinbase_wallet_signature")[];
    web3Strategies: ("web3_coinbase_signature" | "web3_metamask_signature" | "web3_coinbase_wallet_signature")[];
