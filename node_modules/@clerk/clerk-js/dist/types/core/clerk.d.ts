...
import type { __experimental_UserVerificationModalProps, __experimental_UserVerificationProps, ActiveSessionResource, AuthenticateWithCoinbaseParams, AuthenticateWithCoinbaseWalletParams, AuthenticateWithGoogleOneTapParams, AuthenticateWithMetamaskParams, Clerk as ClerkInterface, ClerkAPIError, ClerkAuthenticateWithWeb3Params, ClerkOptions, ClientResource, CreateOrganizationParams, CreateOrganizationProps, DomainOrProxyUrl, EnvironmentJSON, EnvironmentResource, GoogleOneTapProps, HandleEmailLinkVerificationParams, HandleOAuthCallbackParams, InstanceType, ListenerCallback, NavigateOptions, OrganizationListProps, OrganizationProfileProps, OrganizationResource, OrganizationSwitcherProps, SDKMetadata, SetActiveParams, SignInProps, SignInRedirectOptions, SignInResource, SignOut, SignUpProps, SignUpRedirectOptions, SignUpResource, UnsubscribeCallback, UserButtonProps, UserProfileProps, UserResource } from '@clerk/types';
...
export declare class Clerk implements ClerkInterface {
    ...
    authenticateWithCoinbase: (props?: AuthenticateWithCoinbaseParams) => Promise<void>;
    authenticateWithCoinbaseWallet: (props?: AuthenticateWithCoinbaseWalletParams) => Promise<void>;
    authenticateWithWeb3: ({ redirectUrl, signUpContinueUrl, customNavigate, unsafeMetadata, strategy, }: ClerkAuthenticateWithWeb3Params) => Promise<void>;
