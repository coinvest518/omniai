...
export declare function getCoinbaseIdentifier(): Promise<string>;
...
export declare function generateSignatureWithCoinbase({ identifier, nonce }: GenerateSignatureParams): Promise<string>;
export declare function generateSignatureWithCoinbaseWallet({ identifier, nonce, }: GenerateSignatureParams): Promise<string>;
export {};
