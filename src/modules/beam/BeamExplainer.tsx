...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** is a chat modality in Omni Ai to engage multiple AI models. 
...
![Omni Ai BEAM Rays]<img src="https://i.ibb.co/GMgr4my/Black-Blue-Pink-Technology-Geometric-Desktop-Wallpaper.png" alt="Omni Ai BEAM Rays" width="300" style="display: inline-block; margin: 10px 0;" />
...
// There are profound reasons why this approach works, which we explore [in our blog]().
//
// #### Best Use
